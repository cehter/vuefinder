...
import { u as Rh } from "./index-B6ABa3ay.js";
let os = [], Xo = [];
(() => {
  ...
  setup(s, { emit: e }) {
    ...
    async function m(T) {
      ...
      switch (T) {
        ...
        case "jsonc":
        case "lock": {
          const { json: k } = await import("./index-7pCA82wE.js");
          C = k();
          break;
        }
        case "js":
        case "mjs":
        case "cjs": {
          const { javascript: k } = await import("./index-DS9UXBBg.js").then((W) => W.i);
          C = k();
          break;
        }
        case "jsx": {
        ...
        case "html":
        case "htm": {
          const { html: k } = await import("./index-DEtwhstX.js");
          C = k();
          break;
        }
        case "css":
        ...
        case "sass":
        case "less": {
          const { css: k } = await import("./index-DLBHzB3S.js");
          C = k();
          break;
        }
        case "md":
        case "markdown": {
          const { markdown: k } = await import("./index-TppJ3lNp.js");
          C = k();
          break;
        }
        case "yml":
        case "yaml": {
          const { yaml: k } = await import("./index-09FzaJ-3.js");
          C = k();
          break;
        }
        case "xml":
        case "svg": {
          const { xml: k } = await import("./index-_okappq7.js");
          C = k();
          break;
        }
        default:
