...
import { u as Rh } from "./index-DwqGb_y5.js";
let os = [], Xo = [];
(() => {
  ...
  setup(s, { emit: e }) {
    ...
    async function m(T) {
      ...
      switch (T) {
        ...
        case "jsonc":
        case "lock": {
          const { json: k } = await import("./index-DUVVcFXy.js");
          C = k();
          break;
        }
        case "js":
        case "mjs":
        case "cjs": {
          const { javascript: k } = await import("./index-fA-uMhXF.js").then((W) => W.i);
          C = k();
          break;
        }
        case "jsx": {
        ...
        case "html":
        case "htm": {
          const { html: k } = await import("./index-BrB7a_v7.js");
          C = k();
          break;
        }
        case "css":
        ...
        case "sass":
        case "less": {
          const { css: k } = await import("./index-gKgmanmm.js");
          C = k();
          break;
        }
        case "md":
        case "markdown": {
          const { markdown: k } = await import("./index-OqWOUjfb.js");
          C = k();
          break;
        }
        case "yml":
        case "yaml": {
          const { yaml: k } = await import("./index-DX2QR5RF.js");
          C = k();
          break;
        }
        case "xml":
        case "svg": {
          const { xml: k } = await import("./index-BgGwhEr5.js");
          C = k();
          break;
        }
        default:
