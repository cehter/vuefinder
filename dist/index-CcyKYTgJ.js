...
const da = { class: "vuefinder__text-preview" }, ca = { class: "vuefinder__text-preview__body" }, ua = {
  ...
  setup(n, { emit: e }) {
    const t = Ln({
      loader: () => import("./CodeMirrorEditor-DBy_MLox.js").then((g) => g.C),
      delay: 100
  ...
  setup(n, { emit: e }) {
    const t = Ln({
      loader: () => import("./CodeMirrorEditor-DBy_MLox.js").then((ee) => ee.C),
      delay: 100
...
function Jn(n) {
  ...
  return be(() => {
    ...
    w.on("restriction-failed", (V, I) => {
      ...
      A && (A.status = Se.ERROR, A.statusName = I.message);
    }), w.on("upload-start", (V) => {
      V.forEach((I) => {
