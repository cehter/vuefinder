...
import { u as Rh } from "./index-CcyKYTgJ.js";
let os = [], Xo = [];
(() => {
  ...
  setup(s, { emit: e }) {
    ...
    async function m(T) {
      ...
      switch (T) {
        ...
        case "jsonc":
        case "lock": {
          const { json: k } = await import("./index-BI4sjBMP.js");
          C = k();
          break;
        }
        case "js":
        case "mjs":
        case "cjs": {
          const { javascript: k } = await import("./index-CCMrZd6Q.js").then((W) => W.i);
          C = k();
          break;
        }
        case "jsx": {
        ...
        case "html":
        case "htm": {
          const { html: k } = await import("./index-CpidFNJp.js");
          C = k();
          break;
        }
        case "css":
        ...
        case "sass":
        case "less": {
          const { css: k } = await import("./index-CNh3lVSD.js");
          C = k();
          break;
        }
        case "md":
        case "markdown": {
          const { markdown: k } = await import("./index-BVKMpgF5.js");
          C = k();
          break;
        }
        case "yml":
        case "yaml": {
          const { yaml: k } = await import("./index-mBvaJ6WW.js");
          C = k();
          break;
        }
        case "xml":
        case "svg": {
          const { xml: k } = await import("./index-BJhWrvV3.js");
          C = k();
          break;
        }
        default:
