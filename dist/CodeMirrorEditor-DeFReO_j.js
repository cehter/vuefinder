...
import { u as Rh } from "./index-B224AwTD.js";
let os = [], Xo = [];
(() => {
  ...
  setup(s, { emit: e }) {
    ...
    async function m(T) {
      ...
      switch (T) {
        ...
        case "jsonc":
        case "lock": {
          const { json: k } = await import("./index-DJsOvjIH.js");
          C = k();
          break;
        }
        case "js":
        case "mjs":
        case "cjs": {
          const { javascript: k } = await import("./index-awfcuVFl.js").then((W) => W.i);
          C = k();
          break;
        }
        case "jsx": {
        ...
        case "html":
        case "htm": {
          const { html: k } = await import("./index-D-73S1Aq.js");
          C = k();
          break;
        }
        case "css":
        ...
        case "sass":
        case "less": {
          const { css: k } = await import("./index-Cg6sejmr.js");
          C = k();
          break;
        }
        case "md":
        case "markdown": {
          const { markdown: k } = await import("./index-CGhTzKmI.js");
          C = k();
          break;
        }
        case "yml":
        case "yaml": {
          const { yaml: k } = await import("./index-P2UmiIwj.js");
          C = k();
          break;
        }
        case "xml":
        case "svg": {
          const { xml: k } = await import("./index-CeSXsCfj.js");
          C = k();
          break;
        }
        default:
