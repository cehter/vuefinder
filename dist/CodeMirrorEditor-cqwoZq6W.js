...
import { u as Rh } from "./index-DFUQSBCX.js";
let os = [], Xo = [];
(() => {
  ...
  setup(s, { emit: e }) {
    ...
    async function m(T) {
      ...
      switch (T) {
        ...
        case "jsonc":
        case "lock": {
          const { json: k } = await import("./index-CIk3UUqp.js");
          C = k();
          break;
        }
        case "js":
        case "mjs":
        case "cjs": {
          const { javascript: k } = await import("./index-CvObBLl0.js").then((W) => W.i);
          C = k();
          break;
        }
        case "jsx": {
        ...
        case "html":
        case "htm": {
          const { html: k } = await import("./index-D-2Kwk9L.js");
          C = k();
          break;
        }
        case "css":
        ...
        case "sass":
        case "less": {
          const { css: k } = await import("./index-DhnVZ-aN.js");
          C = k();
          break;
        }
        case "md":
        case "markdown": {
          const { markdown: k } = await import("./index-BFqCEwc_.js");
          C = k();
          break;
        }
        case "yml":
        case "yaml": {
          const { yaml: k } = await import("./index-BezMNr57.js");
          C = k();
          break;
        }
        case "xml":
        case "svg": {
          const { xml: k } = await import("./index-Pc78AgLS.js");
          C = k();
          break;
        }
        default:
